const Purchase = [
    { path: '/PurchseOrderTerms', icon: 'fa fa-cube', title: 'PO Terms',
    },
    { path: '/PurchaseOrderStatus', icon: 'fa fa-cube', title: 'Purchase O  Status',
    },
    ...
    { path: '/GRNMain', icon: 'fa fa-key', title: 'GRNMain',
      children: [
        ...
        { path: '/GRNMain/GRNDetails', title: 'GRN Details' },
