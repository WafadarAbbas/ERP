          ...
          <div className="row">
            ...
            <div className=" col-4 d-flex">
              ...
              {formik.touched.supplierId && formik.errors.supplierId && (
                ...
                <div className='col-md-2'style={{ display: "flex", alignItems: "center",marginTop:20}} >

  <button style={buttonStyle} type='button' onClick={() => createRef.current.click()}>+ </button>
  </div>
            </div>
            {/* <div className='col-md-1'style={{ display: "flex", alignItems: "center",marginTop:30}} >
        <button style={buttonStyle} type='button' onClick={() => createRef.current.click()}>+ </button>
    </div> */}
