...
function CreatePurchaseMain() {
      ...
      const buttonStyle = {
        ...
        color: "#333",   
        borderRadius:30,               // Text color
        fontSize: "24px",               // Size of the '+' sign
        width: "40px",                  // Button width (square)
        height: "30px",                 // Button height (square)
        display: "flex",                // Flex container for centering
        alignItems: "center",           // Center vertically
        justifyContent: "center",       // Center horizontally
        cursor: "pointer",              // Pointer cursor
        transition: "all 0.3s ease",    // Smooth transition effect (optional without hover)
      };
