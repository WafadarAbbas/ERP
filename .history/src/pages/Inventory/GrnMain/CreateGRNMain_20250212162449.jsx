  ...
  const addGrnDetail = (detail) => {
    ...
    useEffect(() => {
      if (selectedProductVariantId) {
        const purchaseOrderMainId = 1033;
        const productVariantMainId = selectedProductVariantId;
  
        const fetchData = async () => {
          try {
            const response = await ApiCall(
              "GET",
              `http://localhost:5022/api/v1/PurchseOrderDetails/GetPoBalanceQuantityAndPoQuantity?purchaseOrderMainId=${selectedPurchaseOrder}&productVariantMainId=${productVariantMainId}`
            );
    ...
    //   try {
    //     const response = await ApiCall({
    //       url: `http://localhost:5022/api/v1/PurchseOrderDetails/GetPoBalanceQuantityAndPoQuantity?purchaseOrderMainId=${selectedPurchaseOrder}&productVariantMainId=8`,
    //       method: "GET",
