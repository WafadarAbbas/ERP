...
function CreateGRNMain() {
 ...
 const [isLoading, setIsLoading] = useState(false);
  ...
  const validationSchemagrn = Yup.object().shape({
    ...
    .test(
      "is-less-than-or-equal-to-poBalanceQuantity",
      "Quantity cannot be greater than PO Balance Quantity",
      function (value) {
        const { poBalanceQuantity } = this.options.context;
        if (!poBalanceQuantity) return true; // Allow until balance is loaded
