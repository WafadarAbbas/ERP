    ...
    <div style={{ marginTop: 10 }}>
      ...
      <form onSubmit={grnFormik.handleSubmit} style={{ backgroundColor: 'white', padding: 20, border: "1px solid #d6d4d4", marginBottom: 20 }}>
        ...
        <div className='mb-3'>
          ...
          />
          {grnFormik.errors.branchName && <div className='text-danger'>{grnFormik.errors.branchName}</div>}
        </div>
        ...
        <div className='mb-3'>
          ...
          />
          {grnFormik.errors.grnDocNo && <div className='text-danger'>{grnFormik.errors.grnDocNo}</div>}
        </div>
