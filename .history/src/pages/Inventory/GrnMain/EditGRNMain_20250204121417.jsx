  ...
  return (
    ...
    <div className="col-md-4 mb-3">
        ...
        <input
            ...
            id="grnInvoiceDate"
            name="grnInvoiceDate"
            className={`form-control ${grnFormik.touched.grnInvoiceDate && grnFormik.errors.grnInvoiceDate
                ? "is-invalid"
                : ""
                }`}
            value={grnFormik.values.grnInvoiceDate}
            onChange={grnFormik.handleChange}
            onBlur={grnFormik.handleBlur}
        />
        {grnFormik.touched.grnInvoiceDate && grnFormik.errors.grnInvoiceDate && (
            <div className="invalid-feedback">{grnFormik.errors.grnInvoiceDate}</div>
        )}
    </div>
    <div className="col-md-4 mb-3">
        ...
        <input
            ...
            id="branchId"
            name="branchId"
            className={`form-control ${grnFormik.touched.branchId && grnFormik.errors.branchId ? "is-invalid" : ""}`}
            value={grnFormik.values.branchId}
            onChange={grnFormik.handleChange}
            onBlur={grnFormik.handleBlur}
        />
        {grnFormik.touched.branchId && grnFormik.errors.branchId && (
            <div className="invalid-feedback">{grnFormik.errors.branchId}</div>
        )}
    </div>
    ...
    <div className="col-md-4 mb-3">
        ...
        <input
            ...
            id="branchName"
            name="branchName"
            className={`form-control ${grnFormik.touched.branchName && grnFormik.errors.branchName ? "is-invalid" : ""}`}
            value={grnFormik.values.branchName}
            onChange={grnFormik.handleChange}
            onBlur={grnFormik.handleBlur}
        />
        {grnFormik.touched.branchName && grnFormik.errors.branchName && (
            <div className="invalid-feedback">{grnFormik.errors.branchName}</div>
        )}
    </div>
    ...
    <div className="col-md-4 mb-3">
        ...
        <input
            ...
            id="grnDocNo"
            name="grnDocNo"
            className={`form-control ${grnFormik.touched.grnDocNo && grnFormik.errors.grnDocNo ? "is-invalid" : ""}`}
            value={grnFormik.values.grnDocNo}
            onChange={grnFormik.handleChange}
            onBlur={grnFormik.handleBlur}
        />
        {grnFormik.touched.grnDocNo && grnFormik.errors.grnDocNo && (
            <div className="invalid-feedback">{grnFormik.errors.grnDocNo}</div>
        )}
    </div>
    ...
    <div className="col-md-4 mb-3">
        ...
        <input
            ...
            id="totalGRNVest"
            name="totalGRNVest"
            className={`form-control ${grnFormik.touched.totalGRNVest && grnFormik.errors.totalGRNVest ? "is-invalid" : ""}`}
            value={grnFormik.values.totalGRNVest}
            onChange={grnFormik.handleChange}
            onBlur={grnFormik.handleBlur}
        />
        {grnFormik.touched.totalGRNVest && grnFormik.errors.totalGRNVest && (
            <div className="invalid-feedback">{grnFormik.errors.totalGRNVest}</div>
        )}
    </div>
    ...
    <div className="col-md-4 mb-3">
        ...
        <input
            ...
            id="totalGRNValue"
            name="totalGRNValue"
            className={`form-control ${grnFormik.touched.totalGRNValue && grnFormik.errors.totalGRNValue ? "is-invalid" : ""}`}
            value={grnFormik.values.totalGRNValue}
            onChange={grnFormik.handleChange}
            onBlur={grnFormik.handleBlur}
        />
        {grnFormik.touched.totalGRNValue && grnFormik.errors.totalGRNValue && (
            <div className="invalid-feedback">{grnFormik.errors.totalGRNValue}</div>
        )}
    </div>
