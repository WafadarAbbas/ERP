      ...
      try {
        ...
        if (response?.data) {
          ...
          if (indexToEdit !== -1) {
            ...
            grnFormik.setValues({
              productDefinitionId: data.productDefinitionId || 0,
...
productVariantMainId: data.productVariantMainId || 0,
            });
          }
        } else {
          Swal.fire({
    ...
    const [grnDetails, setGrnDetails] = React.useState([...]); // existing details

// State to hold currently editing id
