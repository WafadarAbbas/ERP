      ...
      if (selectedProductVariantId) {
        ...
        const fetchData = async () => {
          try {
            const response = await ApiCall(
              "GET",
              `http://localhost:5022/api/v1/PurchseOrderDetails/GetPoBalanceQuantityAndPoQuantity?purchaseOrderMainId=${purchaseOrderMainId}&productVariantMainId=${productVariantMainId}`
            );
