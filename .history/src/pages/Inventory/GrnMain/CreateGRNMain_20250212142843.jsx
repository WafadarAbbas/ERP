...
function CreateGRNMain() {
  ...
  const addGrnDetail = (detail) => {
    ...
    const fetchPoBalanceQuantity = async () => {
      try {
        const response = await ApiCall({
          url: "http://localhost:5022/api/v1/PurchseOrderDetails/GetPoBalanceQuantityAndPoQuantity?purchaseOrderMainId=1033&productVariantMainId=8",
          method: "GET",
          params: {
            purchaseOrderMainId: 1033,
            productVariantMainId: 8,
          },
        });
