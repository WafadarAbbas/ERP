...
function CreatePurchaseOrderMain() {
  ...
  const purchaseOrderStatusOptions = Array.isArray(purchaseOrderStatuses)
...
const purchaseOrderTermOptions = Array.isArray(purchaseOrderTerms)
  ...
  const productVariantMainOptions = Array.isArray(productVariantMainId)
...
const measuringUnitOptions = Array.isArray(measuringUnits)
  ...
  onChange={(selectedOption) =>
    formik.setFieldValue("supplierId", selectedOption ? selectedOption.value : "")
  }
...
/>
  ...
  <Select
    ...
    value={
      purchaseOrderStatusOptions.find(
...
<div className="col-md-2 mb-4">
  ...
  <Select
    ...
    options={productVariantMainOptions}
    value={
      productVariantMainOptions.find(
        (option) =>
...
<div className="col-md-2">
  ...
  onChange={(e) => {
    ...
    PurchaseOrderFormik.setFieldValue("poQuantity", value);
    PurchaseOrderFormik.setFieldValue("poBalanceQuantity", value); // Automatically set poBalanceQuantity
  }}
  onBlur={PurchaseOrderFormik.handleBlur}
/>
