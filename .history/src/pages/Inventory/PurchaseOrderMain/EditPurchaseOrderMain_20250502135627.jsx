   ...
   const createRef = useRef(null);
    ...
    const PurchaseOrderFormik = useFormik({
      ...
      onSubmit: (values, { resetForm }) => {
        ...
        let updatedDetails = [...purchseOrderDetails];
      
        if (editIndex !== null) {
          // Replace the existing item at editIndex
          updatedDetails[editIndex] = purchseOrderDetailsData;
          setEditIndex(null); // Reset edit mode after updating
        } else {
          // Add the new item
          updatedDetails.push(purchseOrderDetailsData);
        }
      
        setpurchseOrderDetails(updatedDetails); // Update the state with the new details list
    ...
    PurchaseOrderFormik.errors.measuringUnitsId && (
      <div className="text-danger">
        {PurchaseOrderFormik.errors.measuringUnitsId}
          ...
          <div>
            <button type="submit" className="btn btn-success mt-3 mb-2 col-1" disabled={editIndex === null} >
              Update Detail
            </button>
          </div>
          <hr></hr>
