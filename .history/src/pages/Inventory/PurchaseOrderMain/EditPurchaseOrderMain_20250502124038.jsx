    ...
    try {
      ...
      if (response?.data && Array.isArray(response.data)) {
        ...
        if (data) {
          ...
          Swal.fire({ icon: 'error', title: 'Oops...', text: 'No detail found for this ID!' });
        }
      } else {
      ...
      Swal.fire({ icon: 'error', title: 'Error', text: 'Failed to fetch the data!' });
    }
  };
...
<div className="col-md-2">
  ...
  onClick={() => handleEdit(detail.purchaseOrderMainId, index)}
>
  Edit
</button>
  <button
