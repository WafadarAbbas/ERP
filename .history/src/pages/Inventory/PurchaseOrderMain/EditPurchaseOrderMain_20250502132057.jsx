   ...
   const createRef = useRef(null);
    ...
    const PurchaseOrderFormik = useFormik({
      initialValues: {
        ...
        purchaseOrderMainId: "",
        id: null, // track for edit
      },
      onSubmit: (values, { resetForm }) => {
        if (editingDetailId !== null) {
          // Edit existing
          const updatedList = purchseOrderDetails.map((item) =>
            item.id === editingDetailId ? { ...item, ...values } : item
          );
          setpurchseOrderDetails(updatedList);
          ...
          setpurchseOrderDetails((prev) => [...prev, newDetail]);
        }
        resetForm();
      },
    });
