...
function CreatePurchaseOrderMain() {
  ...
  const validationSchema = Yup.object({
    ...
    purchaseOrderStatusId: Yup.number().required("purchase OrderStatus is required"),
    purchseOrderTermsId: Yup.number().min(1, "PO Terms are required"),
  });
          ...
          <div className="row">
            ...
            <div className="col-md-3 d-flex">
              ...
              <div style={{ display: "flex", alignItems: "center", marginTop: 5, marginLeft: 5, }}>
                <button style={buttonStyle} type="button" onClick={() => createRef.current.click()} > +Sup </button>
              </div>
            </div>
            <div className="col-md-2 mb-4">
