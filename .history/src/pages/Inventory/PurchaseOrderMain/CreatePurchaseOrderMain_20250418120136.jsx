...
function CreatePurchaseOrderMain() {
  ...
  return (
    <div style={{ marginTop: 10 }}>
      ...
      <div style={{ backgroundColor: 'white', padding: 10, boxShadow: "0 4px 6px rgba(0, 0, 0, 0.4)" }}>
        {/* --------------------------------------- */}
    ...
    <td></td>
      ...
      <div className="text-end  pt-5 pb-3 mb-1 bg-white" style={{boxShadow: "0 4px 6px rgba(0, 0, 0, 0.4)"}}>
          <button
            type="submit"
