...
function EditPurchaseOrderMain() {
      ...
      try {
        ...
        if (response && response.data && response.data.length > 0) {
          ...
          formik.setValues({
            ...
            poNumberOfItems: Purchase.poNumberOfItems || "",
            ...
            poQuantity: Purchase.poQuantity || "",
            grnQuantity: Purchase.grnQuantity || "",
            poBalanceQuantity: Purchase.poBalanceQuantity || "",
            grnBatchId: Purchase.grnBatchId || "",
            grnStoreId: Purchase.grnStoreId || "",
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      // http://localhost:5022/api/v1/PurchaseOrderMain/UpdatePurchaseOrderMain
      try {
        const response = await ApiCall({
