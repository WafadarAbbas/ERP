...
const CreateSubCategory = (props) => {
  ...
  return (
    ...
    <button
      ...
      data-bs-target="#CreateSub CategoryModal"
      ref={props.open}
    >
      Create Sub Category
    </button>
    ...
    <div
      ...
      id="CreateSub CategoryModal"
      tabIndex="-1"
      aria-labelledby="CreateSub CategoryModalLabel"
      ...
      <div className="modal-dialog modal-lg modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="CreateSub CategoryModalLabel">
              Create Sub Category
            </h5>
            <button
              type="button"
