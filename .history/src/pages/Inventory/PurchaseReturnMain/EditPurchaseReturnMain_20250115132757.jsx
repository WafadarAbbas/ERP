...
function EditPurchaseReturnMain() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        const response = await ApiCall({
          url: "http://localhost:5022/api/v1/PurchaseReturnMain/UpdatePurchaseReturnMain",
          method: "PUT",
          data: finalData,
        });
  ...
  const PurchaseFormik = useFormik({
    initialValues: {
      ...
      furtherTax: 0,
      furtherTaxAmount: 0,
      valueExclPurchaseReturnMainTax: 0,
      discount: 0,
      discountAmount: 0,
      taxCharged: 0,
      valueIncPurchaseReturnMainTax: 0,
      measuringUnitsId: 0,
      ...
      <div style={{ backgroundColor: 'white', padding: 10, border: "1px solid #d6d4d4" }}>
        ...
        <form onSubmit={PurchaseFormik.handleSubmit}>
          <div className="row border p-2">
            ...
            <div className="col-md-4 mt-3">
              <label htmlFor="valueExclPurchaseReturnMainTax" className="form-label">Value Excl. Purchase Main Tax</label>
              <input
                type="number"
                id="valueExclPurchaseReturnMainTax"
                name="valueExclPurchaseReturnMainTax"
                className={`form-control ${PurchaseFormik.touched.valueExclPurchaseReturnMainTax && PurchaseFormik.errors.valueExclPurchaseReturnMainTax ? 'is-invalid' : ''
                  }`}
                value={PurchaseFormik.values.valueExclPurchaseReturnMainTax}
                onChange={PurchaseFormik.handleChange}
                onBlur={PurchaseFormik.handleBlur}
              />
              {PurchaseFormik.touched.valueExclPurchaseReturnMainTax && PurchaseFormik.errors.valueExclPurchaseReturnMainTax && (
                <div className="invalid-feedback">{PurchaseFormik.errors.valueExclPurchaseReturnMainTax}</div>
              )}
            </div>
            ...
            <div className="col-md-4 mt-3">
              <label htmlFor="valueIncPurchaseReturnMainTax" className="form-label">Value Including Purchase Main Tax</label>
              <input
                type="number"
                id="valueIncPurchaseReturnMainTax"
                name="valueIncPurchaseReturnMainTax"
                className={`form-control ${PurchaseFormik.touched.valueIncPurchaseReturnMainTax && PurchaseFormik.errors.valueIncPurchaseReturnMainTax ? 'is-invalid' : ''
                  }`}
                value={PurchaseFormik.values.valueIncPurchaseReturnMainTax}
                onChange={PurchaseFormik.handleChange}
                onBlur={PurchaseFormik.handleBlur}
              />
              {PurchaseFormik.touched.valueIncPurchaseReturnMainTax && PurchaseFormik.errors.valueIncPurchaseReturnMainTax && (
                <div className="invalid-feedback">{PurchaseFormik.errors.valueIncPurchaseReturnMainTax}</div>
              )}
            </div>
            ...
            <div className="col-md-4 mt-2">
              <label
                htmlFor="PurchaseReturnMainId"
                className="form-label"
              >
                Purchase Main
              </label>
              <select
                name="PurchaseReturnMainId"
                className="form-control"
                value={PurchaseFormik.values.PurchaseReturnMainId}
                onChange={(e) => {
                  PurchaseFormik.setFieldValue(
                    "PurchaseReturnMainId",
                    Number(e.target.value)
              ...
              >
                ...
                {Array.isArray(PurchaseReturnMain) &&
                  PurchaseReturnMain.length > 0 ? (
                  PurchaseReturnMain.map((PurchaseReturnMain) => (
                    <option key={PurchaseReturnMain.id} value={PurchaseReturnMain.id}>
                      {PurchaseReturnMain.name}
                    </option>
                  ))
                ) : (
                  <option value="">
                ...
                <tbody>
                  {purchseDetails.map((detail, index) => (
                    <tr key={index}>
                      ...
                      <td>{detail.PurchaseReturnMainId}</td>
