...
function EditPurchaseReturn() {
  ...
  const formik = useFormik({
    initialValues: {
      PurchaseReturnInvoiceDate: '',
      branchId: 0,
      branchName: '',
      PurchaseReturnDocNo: '',
      totalPurchaseReturnVest: 0,
  ...
  const PurchaseFormik = useFormik({
    initialValues: {
      ...
      furtherTax: 0,
      furtherTaxAmount: 0,
      valueExclPurchaseReturnTax: 0,
      discount: 0,
      discountAmount: 0,
      taxCharged: 0,
      valueIncPurchaseReturnTax: 0,
      measuringUnitsId: 0,
  ...
  const fetchPurchaseReturn = async () => {
    try {
      const response = await ApiCall({
        url: "http://localhost:5022/api/v1/PurchaseReturn/GetPurchaseReturnBoxItems?organizationId=1&companyId=1",
        method: "GET",
      });
      ...
      <div style={{ backgroundColor: 'white', padding: 10, border: "1px solid #d6d4d4" }}>
        ...
        <form onSubmit={PurchaseFormik.handleSubmit}>
          <div className="row border p-2">
            ...
            <div className="col-md-4 mt-3">
              <label htmlFor="valueExclPurchaseReturnTax" className="form-label">Value Excl. Purchase Main Tax</label>
              <input
                type="number"
                id="valueExclPurchaseReturnTax"
                name="valueExclPurchaseReturnTax"
                className={`form-control ${PurchaseFormik.touched.valueExclPurchaseReturnTax && PurchaseFormik.errors.valueExclPurchaseReturnTax ? 'is-invalid' : ''
                  }`}
                value={PurchaseFormik.values.valueExclPurchaseReturnTax}
                onChange={PurchaseFormik.handleChange}
                onBlur={PurchaseFormik.handleBlur}
              />
              {PurchaseFormik.touched.valueExclPurchaseReturnTax && PurchaseFormik.errors.valueExclPurchaseReturnTax && (
                <div className="invalid-feedback">{PurchaseFormik.errors.valueExclPurchaseReturnTax}</div>
              )}
            </div>
            ...
            <div className="col-md-4 mt-3">
              <label htmlFor="valueIncPurchaseReturnTax" className="form-label">Value Including Purchase Main Tax</label>
              <input
                type="number"
                id="valueIncPurchaseReturnTax"
                name="valueIncPurchaseReturnTax"
                className={`form-control ${PurchaseFormik.touched.valueIncPurchaseReturnTax && PurchaseFormik.errors.valueIncPurchaseReturnTax ? 'is-invalid' : ''
                  }`}
                value={PurchaseFormik.values.valueIncPurchaseReturnTax}
                onChange={PurchaseFormik.handleChange}
                onBlur={PurchaseFormik.handleBlur}
              />
              {PurchaseFormik.touched.valueIncPurchaseReturnTax && PurchaseFormik.errors.valueIncPurchaseReturnTax && (
                <div className="invalid-feedback">{PurchaseFormik.errors.valueIncPurchaseReturnTax}</div>
              )}
            </div>
            ...
            <div className="col-md-4 mt-2">
              ...
              <select
                ...
                className="form-control"
                value={PurchaseFormik.values.PurchaseReturnId}
                onChange={(e) => {
                  PurchaseFormik.setFieldValue(
                    "PurchaseReturnId",
                    Number(e.target.value)
              ...
              >
                ...
                {Array.isArray(PurchaseReturn) &&
                  PurchaseReturn.length > 0 ? (
                  PurchaseReturn.map((PurchaseReturn) => (
                    <option key={PurchaseReturn.id} value={PurchaseReturn.id}>
                      {PurchaseReturn.name}
                    </option>
                  ))
                ) : (
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="row">
            ...
            <div className="col-md-4">
              <label htmlFor="PurchaseReturnInvoiceDate" className="form-label">
                Invoice Date
              </label>
              <input
                type="datetime-local"
                id="PurchaseReturnInvoiceDate"
                name="PurchaseReturnInvoiceDate"
                className={`form-control ${formik.touched.PurchaseReturnInvoiceDate && formik.errors.PurchaseReturnInvoiceDate ? 'is-invalid' : ''
                  }`}
                value={formik.values.PurchaseReturnInvoiceDate}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              />
              {formik.touched.PurchaseReturnInvoiceDate && formik.errors.PurchaseReturnInvoiceDate && (
                <div className="invalid-feedback">{formik.errors.PurchaseReturnInvoiceDate}</div>
              )}
            </div>
            ...
            <div className="col-md-4 mt-3">
              <label htmlFor="PurchaseReturnDocNo" className="form-label">
                Document Number
              </label>
              <input
                type="text"
                id="PurchaseReturnDocNo"
                name="PurchaseReturnDocNo"
                className={`form-control ${formik.touched.PurchaseReturnDocNo && formik.errors.PurchaseReturnDocNo ? 'is-invalid' : ''
                  }`}
                value={formik.values.PurchaseReturnDocNo}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              />
              {formik.touched.PurchaseReturnDocNo && formik.errors.PurchaseReturnDocNo && (
                <div className="invalid-feedback">{formik.errors.PurchaseReturnDocNo}</div>
              )}
            </div>

            {/* Total Purchase Main Vest */}
            <div className="col-md-4 mt-3">
              <label htmlFor="totalPurchaseReturnVest" className="form-label">
                Total Vest
              </label>
              <input
                type="number"
                id="totalPurchaseReturnVest"
                name="totalPurchaseReturnVest"
                className={`form-control ${formik.touched.totalPurchaseReturnVest && formik.errors.totalPurchaseReturnVest ? 'is-invalid' : ''
                  }`}
                value={formik.values.totalPurchaseReturnVest}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              />
              {formik.touched.totalPurchaseReturnVest && formik.errors.totalPurchaseReturnVest && (
                <div className="invalid-feedback">{formik.errors.totalPurchaseReturnVest}</div>
              )}
            </div>

            {/* Total Purchase Main Value */}
            <div className="col-md-4 mt-3">
              <label htmlFor="totalPurchaseReturnValue" className="form-label">
                Total Value
              </label>
              <input
                type="number"
                id="totalPurchaseReturnValue"
                name="totalPurchaseReturnValue"
                className={`form-control ${formik.touched.totalPurchaseReturnValue && formik.errors.totalPurchaseReturnValue ? 'is-invalid' : ''
                  }`}
                value={formik.values.totalPurchaseReturnValue}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              />
              {formik.touched.totalPurchaseReturnValue && formik.errors.totalPurchaseReturnValue && (
                <div className="invalid-feedback">{formik.errors.totalPurchaseReturnValue}</div>
              )}
            </div>
            ...
            <div className="col-md-4 mt-3">
              <label htmlFor="totalPurchaseReturnAmount" className="form-label">
                Total Amount
              </label>
              <input
                type="number"
                id="totalPurchaseReturnAmount"
                name="totalPurchaseReturnAmount"
                className={`form-control ${formik.touched.totalPurchaseReturnAmount && formik.errors.totalPurchaseReturnAmount ? 'is-invalid' : ''
                  }`}
                value={formik.values.totalPurchaseReturnAmount}
                onChange={formik.handleChange}
                onBlur={formik.handleBlur}
              />
              {formik.touched.totalPurchaseReturnAmount && formik.errors.totalPurchaseReturnAmount && (
                <div className="invalid-feedback">{formik.errors.totalPurchaseReturnAmount}</div>
              )}
            </div>
