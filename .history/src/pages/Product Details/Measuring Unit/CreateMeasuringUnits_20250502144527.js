...
const CreateMeasuringUnits = (props) => {
  ...
  return (
    ...
    <button
      ...
      data-bs-target="#CreateMeasuringModal"
      ref={props.open}
    >
      Create Measuring
    </button>
    ...
    <div
      ...
      id="CreateMeasuringModal"
      tabIndex="-1"
      aria-labelledby="CreateMeasuringModalLabel"
      ...
      <div className="modal-dialog modal-lg modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="CreateMeasuringModalLabel">
              Create Measuring
            </h5>
            <button
              type="button"
