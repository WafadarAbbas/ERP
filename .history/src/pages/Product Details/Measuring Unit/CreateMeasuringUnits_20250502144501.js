  ...
  return (
    <div>
      <button
        ...
        data-bs-target="#CreateMeasuringUnitsModal"
        ref={props.open}
      >
        Create Product MeasuringUnits
      </button>

      <div
        className="modal fade"
        id="CreateMeasuringUnitsModal"
        tabIndex="-1"
        aria-labelledby="CreateMeasuringUnitsModalLabel"
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="CreateMeasuringUnitsModalLabel">
                Create Product MeasuringUnits
              </h5>
              <button
                type="button"
