...
const CreateMeasuringUnits = (props) => {
  ...
  return (
    ...
    <button
      ...
      data-bs-target="#CreateMeasuringUnitModal"
      ref={props.open}
    >
    ...
    <div
      ...
      id="CreateMeasuringUnitModal"
      tabIndex="-1"
      aria-labelledby="CreateMeasuringUnitModalLabel"
      ...
      <div className="modal-dialog modal-lg modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="CreateMeasuringUnitModalLabel">
              Create MeasuringUnit
            </h5>
            <button
              type="button"
              className="btn-close"
