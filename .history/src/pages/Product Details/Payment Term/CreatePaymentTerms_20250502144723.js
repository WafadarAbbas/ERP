  ...
  return (
    <div>
      <button
        ...
        data-bs-target="#CreatePaymentTermsModal"
        ref={props.open}
      >
        Create Payment Term
      </button>
      ...
      <div
        ...
        id="CreatePaymentTermsModal"
        tabIndex="-1"
        aria-labelledby="CreatePaymentTermsModalLabel"
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="CreatePaymentTermsModalLabel">
                Create Payment Term
              </h5>
              <button
                type="button"
