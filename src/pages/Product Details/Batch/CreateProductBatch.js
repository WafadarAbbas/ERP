  ...
  const handleModalClose = () => {
    ...
    <div>
      <button
        ...
        data-bs-target="#CreateProductBatchModal"
        ref={props.open}
      >
        Create ProductBatch
      </button>
      ...
      <div
        ...
        id="CreateProductBatchModal"
        tabIndex="-1"
        aria-labelledby="CreateProductBatchModalLabel"
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="CreateProductBatchModalLabel">
