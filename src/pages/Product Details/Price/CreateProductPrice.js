...
const CreateProductPrice = (props) => {
...
productVariantMainId: Yup.number()
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      //     url: "http://localhost:5022/api/v1/ProductPrice/SaveProductPrice",
      //     method: "POST",
      //     data: formData,
      //   });
  ...
  return (
    <div>
      <button
        ...
        data-bs-target="#CreateProductPriceModal"
        ref={props.open}
      >
      ...
      <div
        ...
        id="CreateProductPriceModal"
        tabIndex="-1"
        aria-labelledby="CreateProductPriceModalLabel"
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="CreateProductPriceModalLabel">
                Create Product Price
              </h5>
              <button
                type="button"
