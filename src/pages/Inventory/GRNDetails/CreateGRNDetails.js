...
const CreateGRNDetails = (props) => {
  ...
  //     //     url: "http://localhost:5022/api/v1/GRNDetails/SaveGRNDetails",
  //     //     method: "POST",
  //     //     data: formData,
  //     //   });
  ...
  //     //     Swal.fire({
  //     //       title: "Success!",
  //     //       text: "Product GRNDetails saved successfully.",
  //     //       icon: "success",
  ...
  //     //     }
  //     //   } else {
  //     //     throw new Error("Failed to save the product GRNDetails");
  //     //   }
  //     // } catch (error) {
  //     //   console.error("Error during product GRNDetails save:", error);
  //     //   Swal.fire({
  //     //     title: "Error",
  //     //     text: error.message || "An error occurred while saving the product GRNDetails",
  //     //     icon: "error",
  ...
  return (
    <div>
      <button
        ...
        data-bs-target="#CreateGRNDetailsModal"
        ref={props.open}
      >
        Create Product GRNDetails
      </button>

      <div
        className="modal fade"
        id="CreateGRNDetailsModal"
        tabIndex="-1"
        aria-labelledby="CreateGRNDetailsModalLabel"
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="CreateGRNDetailsModalLabel">
                Create Product GRNDetails
              </h5>
              <button
                type="button"
...
export default CreateGRNDetails;
