...
const CreatePurchaseDetail = (props) => {
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        const response = await ApiCall({
          url: "http://localhost:5022/api/v1/PurchaseDetail/SavePurchaseDetail",
          method: "POST",
          data: purchseDetails,
        });
        ...
        if (response?.status === 200) {
          Swal.fire({
            title: "Success!",
            text: "Purchase Detail saved successfully.",
            icon: "success",
          ...
          throw new Error("Failed to save the PurchaseDetail");
        }
      } catch (error) {
        console.error("Error during PurchaseDetail save:", error);
        Swal.fire({
          title: "Error",
          text:
            error.message ||
            "An error occurred while saving the PurchaseDetail",
          icon: "error",
  ...
  return (
    <div>
      <button
        ...
        data-bs-target="#CreatePurchaseDetailModal"
        ref={props.open}
      >
        Create Product PurchaseDetail
      </button>

      <div
        className="modal fade"
        id="CreatePurchaseDetailModal"
        tabIndex="-1"
        aria-labelledby="CreatePurchaseDetailModalLabel"
        ...
        <div className="modal-dialog modal-lg modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="CreatePurchaseDetailModalLabel">
                Create Product PurchaseDetail
              </h5>
              <button
                type="button"
...
export default CreatePurchaseDetail;
