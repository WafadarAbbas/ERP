...
function CreateGRNMain() {
 ...
 const [isLoading, setIsLoading] = useState(false);
  ...
  const validationSchema = Yup.object({
    ...
    grnDocNo: Yup.string().required('GRN Document No is required'),
    totalGRNVest: Yup.number().required('Total GRN Vest is required'),
    totalGRNValue: Yup.number().required('Total GRN Value is required'),
    totalTaxCharged: Yup.number().required('Total Tax Charged is required'),
    totalGRNAmount: Yup.number().required('Total GRN Amount is required'),
    rvMainId: Yup.number().required('RV Main ID is required'),
    term: Yup.string().required('Term is required'),
    narration: Yup.string().required('Narration is required'),
    supplierNTNNo: Yup.string().required('Supplier NTN No is required'),
    supplierSTRNo: Yup.string().required('Supplier STR No is required'),
    taxChargePlusAmount: Yup.number().required('Tax Charge Plus Amount is required'),
    fillerStatus: Yup.boolean().required('Filler Status is required'),
    tax236Amount: Yup.number().required('Tax 236 Amount is required'),
    tax236Rate: Yup.number().required('Tax 236 Rate is required'),
    tax236Status: Yup.boolean().required('Tax 236 Status is required'),
    totalAmountWith236: Yup.number().required('Total Amount with 236 is required'),
    purchaseOrderMainId: Yup.number().required('Purchase Order Main ID is required'),
    ...
    taxStatus: Yup.boolean().required('Tax Status is required'),
    discount: Yup.number().required('Discount is required'),
    furtherTax: Yup.number().required('Further Tax is required'),
  });
  ...
  const validationSchemagrn =  Yup.object({
        quantity: Yup.number()
          ...
          .max(poBalanceQuantity || Infinity, `Quantity must be less or equal to Blnc Qnt ${poBalanceQuantity}`),
      })

  useEffect(() => {
    grnFormik.validateForm();
  }, [poBalanceQuantity]);
